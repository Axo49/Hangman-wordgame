...
function updatesessionStorage() {
  winOutput.innerHTML = `<p>Total win: ${sessionStorage.getItem(
    "localWin"
  )}</p>`;
  loseOutput.innerHTML = `<p>Total lose: ${sessionStorage.getItem(
    "localLose"
  )}</p>`;
}
